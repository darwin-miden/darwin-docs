...
- **[M1 Status](docs/m1-status.md)** — one-page audit of every M1 grant deliverable against what is shipped on testnet today. Start here.
...
- [Milestone 1 Progress Log](docs/m1-progress.md) — week-by-week implementation log mirroring the live state of the `darwin-miden` repos.
